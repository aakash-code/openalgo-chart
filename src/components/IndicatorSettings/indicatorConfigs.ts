...
export const indicatorConfigs: Record<string, IndicatorConfigDefinition> = {
    ...
    riskCalculator: {
        ...
        inputs: [
            ...
            { key: 'product', label: 'Product', type: 'select', options: ['MIS', 'CNC', 'NRML'], default: 'MIS' },
            { key: 'sizingMode', label: 'Sizing Mode', type: 'select', options: ['cash', 'marginPerUnit', 'leverage'], default: 'cash' },
            { key: 'availableMargin', label: 'Available Margin (₹)', type: 'number', min: 0, step: 1, default: 0 },
            { key: 'marginPerUnit', label: 'Margin / Share (₹)', type: 'number', min: 0, step: 0.01, default: 0 },
            { key: 'leverage', label: 'Leverage (x)', type: 'number', min: 1, step: 0.1, default: 5 },
